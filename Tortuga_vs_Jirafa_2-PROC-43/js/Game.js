class Game {
  ...
  play() {
    ...
    camera.position.x =    animals[index - 1].position.x;
         ...
         if (player.positionY > finshLine) {
           ...
           //El código para aumentar la posición del jugador por 1 y actualiza la base de datos.
  ...
  handleGrass(index) {
    animals[index - 1].overlap(grass, function(collector, collected) {
      //La línea correcta de código para aumentar la puntuación por 21 puntos
      player.score += 21;
      // score += 21;
      // player.score + 21;
      // player += 21;
